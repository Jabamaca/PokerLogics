...
namespace TCSHoldEmPoker.Network.Define {
    public enum NetworkActivityID : Int16 {
        ...
        // Player Action
        POKER_GAME_INPUT_PLAYER_INPUT_BET_CHECK         = POKER_GAME_INPUT_PREFIX | PokerGameInputType.PLAYER_ACTION_BET_CHECK,
        POKER_GAME_INPUT_PLAYER_INPUT_BET_CALL          = POKER_GAME_INPUT_PREFIX | PokerGameInputType.PLAYER_ACTION_BET_CALL,
        POKER_GAME_INPUT_PLAYER_INPUT_BET_RAISE         = POKER_GAME_INPUT_PREFIX | PokerGameInputType.PLAYER_ACTION_BET_RAISE,
        POKER_GAME_INPUT_PLAYER_INPUT_BET_FOLD          = POKER_GAME_INPUT_PREFIX | PokerGameInputType.PLAYER_ACTION_BET_FOLD,
    }
}