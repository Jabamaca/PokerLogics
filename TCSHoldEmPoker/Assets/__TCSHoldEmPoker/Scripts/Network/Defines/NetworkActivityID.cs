...
namespace TCSHoldEmPoker.Network.Define {
    public enum NetworkActivityID : Int16 {
        ...
        // POKER GAME SIGNALS
        // Connectivity
        POKER_GAME_INPUT_PLAYER_REQUEST_JOIN            = POKER_GAME_SIGNAL_PREFIX | PokerGameInputType.PLAYER_REQUEST_JOIN,
        POKER_GAME_INPUT_PLAYER_REQUEST_LEAVE           = POKER_GAME_SIGNAL_PREFIX | PokerGameInputType.PLAYER_REQUEST_LEAVE,
        // Player Action
        POKER_GAME_INPUT_PLAYER_INPUT_BET_CHECK         = POKER_GAME_SIGNAL_PREFIX | PokerGameInputType.PLAYER_ACTION_BET_CHECK,
        POKER_GAME_INPUT_PLAYER_INPUT_BET_CALL          = POKER_GAME_SIGNAL_PREFIX | PokerGameInputType.PLAYER_ACTION_BET_CALL,
        POKER_GAME_INPUT_PLAYER_INPUT_BET_RAISE         = POKER_GAME_SIGNAL_PREFIX | PokerGameInputType.PLAYER_ACTION_BET_RAISE,
        POKER_GAME_INPUT_PLAYER_INPUT_BET_FOLD          = POKER_GAME_SIGNAL_PREFIX | PokerGameInputType.PLAYER_ACTION_BET_FOLD,
    }
}